...
public class Main {
	...
	public static void main(String[] args) {
		...
		SortTestHelper.testSort("SortingBasic.OptimizedSelectionSort.SelectionSort", arr1);
		SortTestHelper.testSort("SortingBasic.OptimizedSelectionSort.SelectionSort2", arr3);
		SortTestHelper.testSort("SortingBasic.OptimizedSelectionSort.InsertionSort", arr2);
