...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String filename1 = "src/MinimumSpanTrees/KruskalAlgorithm/testG1.txt";
        int V1 = 8;

        String filename2 = "src/MinimumSpanTrees/KruskalAlgorithm/testG2.txt";
        int V2 = 250;

        String filename3 = "src/MinimumSpanTrees/KruskalAlgorithm/testG3.txt";
        int V3 = 1000;

        String filename4 = "src/MinimumSpanTrees/KruskalAlgorithm/testG4.txt";
        int V4 = 10000;
